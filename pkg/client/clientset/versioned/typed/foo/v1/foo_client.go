...
import (
	...
	"github.com/liangrog/kube-crd-example/pkg/client/clientset/versioned/scheme"
...
func (c *ExampleV1Client) ClusterHelloTypes() ClusterHelloTypeInterface {
	return newClusterHelloTypes(c)
}

func (c *ExampleV1Client) HelloTypes(namespace string) HelloTypeInterface {
