...
type Interface interface {
	// ClusterHelloTypes returns a ClusterHelloTypeInformer.
	ClusterHelloTypes() ClusterHelloTypeInformer
...
// ClusterHelloTypes returns a ClusterHelloTypeInformer.
func (v *version) ClusterHelloTypes() ClusterHelloTypeInformer {
	return &clusterHelloTypeInformer{factory: v.factory, tweakListOptions: v.tweakListOptions}
}
